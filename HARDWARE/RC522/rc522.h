...
void Printing(unsigned char* Buffer,unsigned short len);//发送数组到串口		     
u8 Request_Anticoll_Select(u8 request_mode,u16 card_type,u8* card_buffer,u8* card_id);//寻卡、防冲撞、选卡
